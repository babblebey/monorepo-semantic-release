...
function normalizeOptions(values) {
  ...
  const extendsList = toList(values.extends);
  if (extendsList) {
    options.extends = extendsList;
  }
  ...
  try {
    const { values } = parseArgs({
      ...
      options: {
        ...
        extends: { type: "string", short: "e", multiple: true },
